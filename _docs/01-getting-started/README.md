...
All documentation is organized in the `_docs/` folder:
...
See `_docs/README.md` for the complete documentation index.
...
See `_docs/02-setup/` for detailed setup instructions.
